...
class SeHomeworkPlatform extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['uploadTime', 'isDelete', 'subjectId', 'gradeId', 'getType', 'author', 'creator', 'status', 'department', 'sourceHomeworkTeacherId', 'level', 'sourceType', 'difficulty', 'backendOperater'], 'integer'],
