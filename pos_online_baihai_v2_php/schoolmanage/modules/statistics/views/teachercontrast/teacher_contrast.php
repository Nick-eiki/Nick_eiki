                    ...
                    <div class="tabItem">
                        <div class="echarts_item" style="margin: 0">
                            ...
                            <ul id="subList_con" class="subList_con">
                                ...
                                <li data-sel-value="<?=$v->subjectId?>" data-sel-item=""><a href="javascript:;"><?php echo SubjectModel::model()->getSubjectName($v->subjectId)?></a><span class="arrow"></span></li>
                                <?php }?>
                            </ul>
...
<script>
    ...
    $('#subList_con').find('li').click(function(){
      var $this=$(this);
