...
$this->registerCssFile(publicResources_new() . '/css/statistic.css');
$this->registerJsFile(publicResources_new() . "/js/lib/echarts/echarts.js" , ['position'=>\yii\web\View::POS_HEAD ]);
?>
