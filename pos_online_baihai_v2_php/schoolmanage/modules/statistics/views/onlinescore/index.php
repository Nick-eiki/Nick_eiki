                            ...
                            <div  class="tableWrap" style="padding-top: 20px">
                                <table class="sUI_table sUI_table_border online_table">
                                    ...
                                    foreach($seExamSubject as $subject){
                                        ...
                                        ?>
                                    <th colspan="3"><?= \frontend\models\dicmodels\SubjectModel::model()->getSubjectName($subject->subjectId)?></th>
                                    <?php }?>
                                    </thead>
                                    <tbody>
                                    <tr>
                                    ...
                                    <?php foreach($data as $key => $val){ ?>
                                        <tr>
                                            <td><?= \frontend\components\WebDataCache::getClassesName($key) ?></td>
                                ...
                                <div class="pannel_r">
                                    <select id="grade_select" data-id="<?php echo $examId?>">
                                        ...
                                        <?php foreach($examClass as $class){?>
                                            <option data-id="<?php echo $class->classId?>"><?php echo \frontend\components\WebDataCache::getClassesName($class->classId) ?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
