...
<div class="main col1200 clearfix statistic_index" id="requireModule" rel="app/statistic/statistic_index">
	<div class="aside col260 no_bg alpha">
		<?php echo $this->render("_index_exam_left_department_grade_list",['searchArr'=>$searchArr, "gradeModel"=>$gradeModel, 'department'=>$department,]);?>
	</div>

	<div class="container col910 no_bg omega">
		<div class="item sel_test_bar">
			<?php echo $this->render("_index_exam_select_type_list",[ 'gradeId'=>$gradeId, 'departmentId'=>$departmentId, 'yearArr' => $yearArr,]);?>
		</div>
