                            ...
                            <div class="sUI_pannel  title_pannel">
                                ...
                                <div class="pannel_r">
                                    <select id="grade_select" data-id="<?= $examId?>">
                                        ...
                                        <option data-id="<?= $class->classId?>"><?= \frontend\components\WebDataCache::getClassesName($class->classId) ?></option>
                                        <?php }?>
                                    </select>
                                    <select id="subject_select" data-id="<?= $examId?>">
                                        <option data-id="">全部学科</option>
                                        <?php foreach($seExamSubject as $subject){?>
                                        <option data-id="<?= $subject->subjectId?>"><?= \frontend\models\dicmodels\SubjectModel::model()->getSubjectName($subject->subjectId)?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
