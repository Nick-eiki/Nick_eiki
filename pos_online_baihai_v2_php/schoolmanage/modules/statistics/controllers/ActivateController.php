...
class ActivateController extends SchoolManageBaseAuthController
{
    ...
    public function actionIndex()
    {
        ...
        $noActivate = floatval($teacherNum['teacher']) - floatval($activateNum['teacher']);
        //学部 科目
        ...
        $pages->totalCount = intval($teacherList->count());
    ...
    public function actionStudent(){
        ...
        $noActivate = floatval($studentNum['student']) - floatval($activateNum['student']);
    ...
    public function actionHome(){
        ...
        $noRegister = floatval($homeNum['home']) - floatval($register['home']);
        if($register['home']==0){
            $proportion = 0;
        }else{
