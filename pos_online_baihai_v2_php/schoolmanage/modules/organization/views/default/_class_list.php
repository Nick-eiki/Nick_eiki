	...
	<table class="sUI_table">
		...
		foreach ($classListData as $item) {
			...
			<tr class="u<?php echo $item["gradeID"]; ?>">
                <td><?php echo WebDataCache::getClassDepartment($departmentId); ?></td>
                <td><?php echo $item["joinYear"]; ?></td>
                <td><?php echo WebDataCache::getGradeName($item["gradeID"]); ?></td>
                ...
                <td><?php echo WebDataCache::getClassStatus($item['status']); ?></td>
