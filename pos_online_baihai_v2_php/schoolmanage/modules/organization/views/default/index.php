...
$this->registerCssFile(publicResources_new() . '/css/class_mag.css');
...
<div class="main col1200 clearfix sch_mag_person sch_mag_teacher" id="requireModule" rel="app/school/app">
    ...
    <div class="container col910 omega currency_hg">
        ...
        <div class="class_status">
            <button id="update" data-alert="on"><i class="update"></i>升级</button>
    ...
    <div class="aside col260 alpha no_bg clearfix">
        <div class="asideItem">
            <ul class="left_menu">
<!--                <li><a class="" href="/personnel/teacher/index">学校管理</a></li>-->
                <li><a class="cur" href="<?php echo Url::to(['/organization/default/index'])?>">班级管理</a></li>
<!--                <li><a class="" href="/personnel/student/index">教研组管理</a></li>-->
            </ul>
        </div>
    </div>
