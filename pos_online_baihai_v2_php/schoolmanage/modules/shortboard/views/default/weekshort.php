        ...
        <div class="item sel_test_bar">
            <div id="time_tab" class="sUI_tab">
                <ul class="tabList clearfix" style="background: #fff">
                    <li><a href="<?php echo Url::to(["/shortboard/default/index",'schoolLevel'=>$schoolLevelId,'gradeId'=>$gradeId]);?>">月短板</a></li>
                    <li><a href="<?php echo Url::to(["/shortboard/default/week-short",'schoolLevel'=>$schoolLevelId,'gradeId'=>$gradeId]);?>" class="ac">周短板</a></li>
                </ul>
                <div class="tabCont">
                    <div class="tabItemm selector clearfix">
                        <div class="gnn_tabCon">
                            <label>学科：</label>
                            <select id="subject_select1" gradeId="<?php echo $gradeId;?>" schoolLevelId=<?php echo $schoolLevelId ;?>>
