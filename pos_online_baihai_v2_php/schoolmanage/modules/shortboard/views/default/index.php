...
<div class="main col1200 clearfix school_short_pool" id="requireModule" rel="app/shortboard/shortboard_index">
    <div class="aside col260 no_bg alpha">
        <?php echo $this->render("_index_exam_left_department_grade_list",['searchArr'=>$searchArr,"gradeModel"=>$gradeModel,'department'=>$department,'lengthOfSchooling'=>$lengthOfSchooling]);?>
    </div>
        ...
        <div class="item sel_test_bar">
            <div id="time_tab" class="sUI_tab">
                <ul class="tabList clearfix" style="background: #fff">
                    <li><a href="<?php echo Url::to(["/shortboard/default/index",'schoolLevel'=>$schoolLevelId,'gradeId'=>$gradeId]);?>" class="ac">月短板</a></li>
                    <li><a href="<?php echo Url::to(["/shortboard/default/week-short",'schoolLevel'=>$schoolLevelId,'gradeId'=>$gradeId]);?>">周短板</a></li>
                </ul>
                <div class="tabCont">
                    <div class="tabItemm selector clearfix">
                        <div class="gnn_tabCon">
                            <label>学科：</label>
                            <select id="subject_select" gradeId="<?php echo $gradeId;?>" schoolLevelId=<?php echo $schoolLevelId ;?>>
                            ...
                            <label>月份：</label>
                            <input class="text0" placeholder="点击选择月" value="<?php echo date('Y-m',strtotime('-1 month'))?>">
