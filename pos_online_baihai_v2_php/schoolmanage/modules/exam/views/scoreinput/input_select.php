...
?>
    <div class="main col1200 clearfix sch_mag_input" id="requireModule" rel="app/sch_mag/sch_mag_input_select">
        <div class="container testTitle">
            <a href="<?php echo Url::to('/exam')?>" class="btn btn30 icoBtn_back gobackBtn"><i></i>返回</a>
            <h4><?php echo $examName;?></h4>
        </div>
        <div class="container input_banner"><img src="/pub/images/school_banner.jpg"></div>
        <div class="container">
            <div class="pd25">
                ...
                <hr>
                <div id="editCont" class="edit_input show_btnBar">
                    <div class="btnBar tc">
