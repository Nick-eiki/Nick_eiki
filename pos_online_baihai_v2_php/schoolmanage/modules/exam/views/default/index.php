...
?>
<div class="main col1200 clearfix sch_mag_testMag_home" id="requireModule" rel="app/sch_mag/sch_mag_home">
    <div class="sch_mag_left aside col260 no_bg  alpha">
        ...
        <div class="asideItem">
            <ul class="left_menu">
                <?php echo $this->render("_index_exam_grade_list", ["gradeModel"=>$gradeModel, "searchArr"=>$searchArr])?>
            </ul>
        </div>
    </div>
    <div class="sch_mag_right container no_bg col910 omega">
        <div class="item">
            <?php echo $this->render("_index_exam_select_type_list",[ 'gradeId'=>$gradeId, 'department'=>$department, 'yearArr' => $yearArr,]);?>
...
<script>
    $(".cj_exma").click(function() {
        var department="<?=$department?>";
        $.post("<?=Url::to('/exam/default/get-exam-box')?>",{
            department:department
        },function(result){
               $('#examConBox').html(result).dialog("open");
        });
    });
</script>