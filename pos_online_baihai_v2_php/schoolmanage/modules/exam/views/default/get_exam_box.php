        ...
        <div class="sUI_formList">
            ...
            <div class="row">
                ...
                <div class="form_r exam_grade">
                    <?php foreach($gradeData as $k=>$v){
                        ?>
                        <label>
                            <input type="checkbox" class="checkbox validate[minCheckbox[1]]" name="grade[]" value="<?=$v->gradeId?>"  data-errormessage-range-underflow="请选择年级"><?php echo GradeHelper::getComingYearByGrade($v->gradeId,$schoolData->lengthOfSchooling).'级（现'.$v->gradeName.'）'?></label>
                        <?php if(($k+1)%3==0){?>
                            <br>
                        <?php } }?>
                </div>
            ...
            <div class="row">
                ...
                <div class="form_r exam_grade schoolYear">
                    <label>
                        <?php $currentYear=GradeHelper::getCurrentSchoolYear();?>
...
<script>
    ...
    $('[name="grade[]"]').click(function(){
        ...
        if(gradeArray.length>0){
            ...
            $.post(url,{schoolID:schoolID,gradeArray:gradeArray},function(result){
