...
class SchoolManageBaseAuthController extends BaseAuthController
{
     ...
     */
    public function getSeExamSchoolModel($schoolExamId)
    {
     ...
     * @throws \yii\web\HttpException
     */
    public function getSchoolClassModel($classId)
    {
     ...
     * @throws \yii\web\HttpException
     */
    public function getSchoolUserModel($userID){
     ...
     * @throws \yii\web\HttpException
     */
    public function  getSchoolUser($userId){
