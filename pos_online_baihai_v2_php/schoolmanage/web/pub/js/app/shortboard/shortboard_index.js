define(["popBox",'FlexoCalendar','jquery_sanhai', 'jqueryUI'], function(popBox) {
    ...
    $(".search").click(function () {
        ...
        var gradeId = $('#subject_select').attr('gradeId');
        var schoolLevelId = $('#subject_select').attr('schoolLevelId');
        var month = $('.text0').val();
        $.get('/shortboard/default/index',{subjectId:subjectId,gradeId:gradeId,schoolLevel:schoolLevelId,month:month},function(data){
    ...
    $(".search1").click(function () {
        ...
        var gradeId = $('#subject_select1').attr('gradeId');
        var schoolLevelId = $('#subject_select1').attr('schoolLevelId');
        var weekstart = $('.text1').attr('start');
        var weekend = $('.text1').attr('end');
        $.get('/shortboard/default/week-short',{subjectId:subjectId,gradeId:gradeId,schoolLevel:schoolLevelId,weekstart:weekstart,weekend:weekend},function(data){
            $("#shortboard").html(data);
        });
