...
define(["popBox", 'jquery_sanhai', 'jqueryUI'], function(popBox) {
    $(".subList_con").sel_list('multi',function(elm){
        ...
        //10010-》语文，10011-》数学，10012-》英语，10013-》生物，10014-》物理，10015-》化学，10016-》地理，10017-》历史，10018-》政治，10023-》信息技术，10026-》科学，10027->理综,10028->文综,10029-》思想品德，10030-》品德与社会，10031-》心理，10032-》健康，10033-》校本课程，10034->地方课程，10035-》劳动与技术，10037-》学法指导，10038-》写字，10039-》蒙古语文，10040-》汉语,10041->俄语



        var html='<tr id="'+data+'_subject">';
        html+='<td>'+subject[data]+'</td>';
        html+='<td><input type="hidden" name="man[]" value="'+data+'"> <input type="text" class="fraction score_p" name="'+data+'_full"></td>';
        html+='<td><input type="text" class="fraction score_l" name="'+data+'_cutLine"></td>';
        html+='<td></td>';
        html+='</tr>';
    ...
    $(document).on('blur','#table_set_up input',function(){
        ...
        if(rg.test(val)|| val<0 || val>999 || isNaN(val)){
            ...
            pa.find('input').removeClass('input_error');
            score_sum();//计算总分
        }
    });
