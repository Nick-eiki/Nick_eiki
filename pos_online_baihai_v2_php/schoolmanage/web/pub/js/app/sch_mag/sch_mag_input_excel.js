define(["popBox", 'jquery_sanhai', 'jqueryUI'], function(popBox) {
    ...
    function create_table(data) {
        var subject = {'10010': '语文','10011': '数学','10012': '英语','10013': '生物','10014': '物理','10015': '化学','10016': '地理','10017': '历史','10018': '政治','10023': '信息技术','10026': '科学','10027': '理综','10028': '文综','10029': '思想品德','10030': '品德与社会','10031': '心理','10032': '健康','10033': '校本课程','10034': '地方课程','10035': '劳动与技术','10037': '学法指导','10038': '写字','10039': '蒙古语文','10040': '汉语','10041': '俄语','10027': '理综','10028': '文综' }
        ...
        if(data.other_student.length>0) {
            ...
            html += '<table class="sUI_table sys_name_table fl" style="width: 100px;border-right: 1px solid #dcdcdc;">';
            html += '<thead>';
            html += '<tr><th>学生姓名</th></tr>';
            html += '</thead>';
            html += '<tbody>';
            for (var k = 0; k < data.other_student.length; k++) {
                html+='</tr><td><em data-student-num="'+data.other_student[k].name+'">' +data.other_student[k].name+ '</em></td></tr>';
            }
            html += '</tbody>';
            html += '</table>';
            ...
            if(chk_error>0){
                ...
                $.post('auto-save-score-finish', $input_form.serialize(),function(data){
                    if(data.success){
                        ...
                        window.location.href= '/exam/scoreinput?examId='+data.data;
                    }else{
