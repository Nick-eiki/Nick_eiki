...
<div class="main classes_file col1200 clearfix" id="requireModule" rel="app/classes/classes_file">
        ...
        <div class="pd25">
            ...
            <div id="classes_file_crumbs" class="classes_file_crumbs">
                ...
                <?php if(!empty($subjectid)){?>
                    <span>科目:<em><?= SubjectModel::model()->getSubjectName($subjectid)?></em>
                ...
                <?php if(!empty($mattype)){?>
                    <span>类型:<em><?= FileModel::model()->getClassDutyName($mattype)?></em>
                ...
                <div class="row  classes_sel_list">
                    ...
                    <div class="form_r moreContShow">
                        ...
                        <ul>
                            ...
                            $teaGra = \common\helper\UserInfoHelper::getUserSubjectId(user()->id);
    ...
    <div class="container no_bg">
        ...
        <div id="classFile">
            <?php echo $this->render('_classfile_list', array('materialList' => $materialList, 'classId' => $classId, 'pages' => $pages)) ?>
        </div>
