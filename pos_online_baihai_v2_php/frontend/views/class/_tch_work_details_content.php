...
<div class="container homwork_info">
	<div class="pd25">
		<p><em>版本：</em><?php echo EditionModel::model()->getEditionName($homeworkDetailsTeacher->version) ?></p>

		<?php if (!empty($homeworkDetailsTeacher->chapterId)) {
			$chapterInfo = ChapterInfoModel::findChapter($homeworkDetailsTeacher->chapterId);
			?>
