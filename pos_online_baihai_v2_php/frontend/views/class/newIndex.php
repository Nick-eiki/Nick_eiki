...
<div class="container alpha omega">
    <div class="classes_cont">
        ...
        if ($this->beginCache(WebDataKey::WEB_CLASS_VIEW_CACHE_KEY . $classModel->classID . '_' . !empty($isInClass), ['duration' => 600])) {
                    ...
                    <ul class="image-row">
                        <?php
                            foreach($eventPicDate as $item){
                                ?>
                                <li>
                                    <a class="fancybox" href="<?php echo $item['picUrl']; ?>"
...
<div class="container">
    ...
    <?php
    if ($this->beginCache(WebDataKey::WEB_CLASS_VIEW_MEMBER_CACHE_KEY . $classModel->classID, ['duration' => 600])) {
