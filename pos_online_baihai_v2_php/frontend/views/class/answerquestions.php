...
?>
<script src="<?= publicResources_new2() ?>/js/lib/echarts/echarts.js<?=RESOURCES_VER ?>" type="text/javascript"></script>
...
<div class="main clearfix col1200 classes_answering_question" id="requireModule" rel="app/classes/classes_answering_question"  data-script="classes_answering_question" >
	...
	<div class="container col910 alpha no_bg">
				...
				<div id="classes_sel_list" class="sUI_formList sUI_formList_min  classes_file_list ">
					...
					<div class="row clsId" cls="<?php echo $classId?>">
						...
						<div class="form_r">
							<ul>
								<li class="is_solved">
									<a data-sel-item href="javascript:;" solved_type="1"><i class="already_solved"></i>已解决</a>
								</li>
								<li class="is_solved">
		...
		<?php echo $this->render('//publicView/answer/_new_answer_question_list',['modelList' => $modelList, 'pages' => $pages, 'classId' => $classId])?>
		</div>
	</div>
		...
		<div class="asideItem asker_list">
			...
			<div class="pd15">
				<ul>
					...
					<li>
						<img data-type="header" onerror="userDefImg(this);"  width="40" height="40" src="<?php echo publicResources() . WebDataCache::getFaceIcon($sortVal['creatorID']);?>" alt="" creatorID="<?php echo $sortVal['creatorID']; ?>">
