...
<div class="main stu_hmwk_list col1200 clearfix classes_answering_question" id="requireModule" rel="app/classes/stu_hmwk_list">
			...
			<div id="classes_sel_list" class="sUI_formList sUI_formList_min classes_file_list " cl="<?php echo $classId;?>">
				...
				<div class="row">
					<div class="form_l tl click_state">
						<a class="sel_ac" state="1" data-sel-item href="javascript:;">全部状态</a>
					</div>
					<div class="form_r">
						<ul>
							<li class="click_state"><a state="2" data-sel-item href="javascript:;">已完成</a></li>
							<li class="click_state"><a state="3" data-sel-item href="javascript:;">未完成</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<div class="container no_bg">
		<div class="classbox">
			<?php echo $this->render("_homework_list_stu",['homework'=>$homework, 'studentMember'=>$studentMember, 'classId'=>$classId, 'pages'=>$pages, "state"=>$state])?>
		</div>
	</div>
</div>
