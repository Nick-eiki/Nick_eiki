	...
	<div class="container">
		<div id="reply_tab" class="tab tabList_border">
			<ul class="tabList clearfix ">
				<li>
					<a href="<?php echo Url::to(['class/work-detail','classId'=>$classId,'classhworkid'=>$classhworkId,'type'=>'1'])?>" class="ac" type="1">未批改</a>
				</li>
			...
			<div class="tabCont work_detailTab noBorder">
				...
				<div class="tabItem">
					<div class="">
						<ul class="resultList testClsList " clId="<?php echo $classId; ?>" classhworkId="<?php echo $classhworkId; ?>">
					...
					<?php echo $this->render("_tch_work_details_no_corrections_new", ['noCorrections'=>$noCorrections,'onTimeNumber'=>$onTimeNumber,'overtime'=>$overtime,'answer' => $answer, 'homeworkDetailsTeacher' => $homeworkDetailsTeacher, 'page' => $page, "classId" => $classId, 'classhworkId'=>$classhworkId]); ?>
					</div>
				</div>
			</div>
		</div>
