...
<div class="centRightT">
    ...
    <ul class="class_list clearfix">
        ...
        foreach ($memberData as $val) {
            ?>
            <li><a href="<?php echo url('student/default/index',array('studentId'=>$val->userID)) ?>"><img  data-type="header" onerror="userDefImg(this);"  src="<?php echo publicResources() . WebDataCache::getFaceIcon($val->userID) ?>"
