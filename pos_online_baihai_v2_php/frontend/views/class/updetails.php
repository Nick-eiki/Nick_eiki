...
<div class="main col1200 clearfix tch_hmwk_result" id="requireModule" rel="app/classes/tch_hmwk_veiw_paper" >
    ...
    <div class="container homwork_info">
        <div class="pd25">
            <?php if(!empty($homeworkData->version)){?><p><em>版本：</em><?=EditionModel::model()->getEditionName($homeworkData->version); ?></p><?php }?>
                ...
                <div class="slidePaperWrap mc">
                    <ul id="slidePaperList" class="slidePaperList ">
                        ...
                        <?php foreach($imageList as $list){?>
                            <li name="111"><img src="<?= $list->url?>"  alt=""/><span></span></li>
