			        ...
			        <div class="checkArea" style="margin:0 ">
				        <div class="oneself clearfix">
					        <p class="onese">
						        ...
						        <?php foreach($item->picList as $v){?>
							        <a href="<?php echo url('student/managetask/view-correct',array('questionId'=>$item->questionId,"homeworkAnswerID"=>$homeworkAnswerID))?>">  <img width="50" height="48" alt="" src="<?php echo $v->picUrl ?>"></a>
						        <?php } ?>
					        </p>
...
//		echo '<p>'.$item->content.'</p>';
	...
	<div class="checkArea">
		...
		foreach ($item->picList as $picVal) {
			...
			<a href="<?php echo url('student/managetask/view-correct',array("homeworkAnswerID"=>$homeworkAnswerID))?>">
