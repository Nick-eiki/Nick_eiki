...
$this->registerJsFile(publicResources_new2() . '/js/lib/My97DatePicker/WdatePicker.js');
?>
	...
	<div class="row">
		<div class="form_l">
			<img class="userHeadPic" data-type="header" onerror="userDefImg(this);" width="40px" height="40px"
			     src="<?php echo ImagePathHelper::imgThumbnail(WebDataCache::getFaceIcon(user()->id),70,70); ?>" alt="">
		</div>
		<div class="form_r">
