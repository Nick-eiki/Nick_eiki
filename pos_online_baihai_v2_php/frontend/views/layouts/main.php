...
<head>
    ...
    <link href="<?= publicResources_new() ?>/css/base.css<?=RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?= publicResources_new() ?>/css/jquery-ui.css<?=RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?= publicResources_new() ?>/css/popBox.css<?=RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon">
    <script src="<?= publicResources_new() ?>/js/jquery-1.7.1.min.js<?=RESOURCES_VER ?>" type="text/javascript"></script>
    <script src="<?= publicResources_new() ?>/js/jquery-ui.min.js<?=RESOURCES_VER ?>" type="text/javascript"></script>
    <script src="<?= publicResources_new() ?>/js/base.js<?=RESOURCES_VER ?>" type="text/javascript"></script>
...
<script src="<?php echo publicResources_new() ?>/js/jquery.blockUI.js"  type="text/javascript"></script>
...
<?php $this->endBody() ?>
<script src="<?php echo publicResources_new() ?>/js/lazyload/jquery.lazyload.js?v=1.9.1"></script>
...
<noscript><p><img src="//www.banhai.com:86/piwik.php?idsite=1" style="border:0;" alt="" /></p></noscript>
<!-- End Piwik Code -->
