...
<head>
    ...
    <link href="<?= publicResources_new2() ?>/css/base.css<?= RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?= publicResources_new2() ?>/css/sUI.css<?= RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?= publicResources_new2() ?>/css/jquery-ui.css<?= RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?= publicResources_new2() ?>/css/popBox.css<?= RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?= publicResources_new2() ?>/css/sUI.css<?= RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon">

    <script src="<?= publicResources_new2() ?>/js/require.js" type="text/javascript"></script>
    <script src="<?= publicResources_new2() ?>/js/jquery.js<?= RESOURCES_VER ?>" type="text/javascript"></script>
...
<script src="<?php echo publicResources_new2() ?>/js/lib/lazyload/jquery.lazyload.js?v=1.9.1"></script>
<script type="text/javascript" charset="utf-8">
    $(function () {



        require(['<?php echo publicResources_new2() ?>/js/lib/jquery.blockUI.js'], function () {
