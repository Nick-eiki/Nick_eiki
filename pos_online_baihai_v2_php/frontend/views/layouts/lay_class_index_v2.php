...
use common\services\AdManageService;
...
$teacherCount = SeClassMembers::find()->where(['classID'=>$classId ,'identity'=>20402])->andWhere([ '>','userID',0])->count();
$masterCount = SeClassMembers::find()->where(['classID'=>$classId ,'identity'=>20401])->andWhere([ '>','userID',0])->count();
$studentCount = SeClassMembers::find()->where(['classID'=>$classId ,'identity'=>20403])->andWhere([ '>','userID',0])->count();
    ...
    <div class="infoBar pr col1200">
        <dl class="classes_head clearfix">
            ...
            <dd class="">
                ...
                <div class="tab_ls">
                    <p>教师（<?php echo $teacherCount+$masterCount;?>）人</p>
...
<div class="col1200">
    <div id="classes_AD_banner" class="container  classes_AD_banner">
        <ul id="classes_AD_banner_list" class="classes_AD_banner_list">
            <li><a href="<?php echo $adValue->href;?>">
