...
<head>
    ...
    <link href="<?php echo publicResources_new() ?>/css/base.css<?=RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo publicResources_new() ?>/css/jquery-ui.css<?=RESOURCES_VER ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo publicResources_new() ?>/css/popBox.css<?=RESOURCES_VER ?>" rel="stylesheet" type="text/css">
