...
/* @var  PublicityForm[] $publicityForm */  $this->title='学校-添加公示';
?>
        ...
        <div class="main_cont school_new_public">
            ...
            <div class="form_list">
                <div class="row">
                    ...
                    <div class="formR">
                        <input type="text" name="<?php echo Html::getInputName($publicityForm, 'publicityTitle') ?>"  data-errormessage-value-missing="名称不能为空！" data-prompt-position="inline" data-prompt-target="titleError"  data-validation-engine="validate[required,maxSize[30]]" class="text" style=" width:550px">
                    ...
                    <div class="formR">
                    	<span class="selectWrap big_sel" style="width:120px">
                            <i></i>
                           	<em>请选择</em>
                           <?php
                           echo Html:: activeDropDownList($publicityForm, "publicityType",array("1"=>"校园公告","2"=>"校园生活","3"=>"校园新闻","4"=>"教育综合","5"=>"招生动态","6"=>"荣誉墙",),
                               array(
                ...
                <div class="row">
                    ...
                    <div class="formR">
                    	<textarea class="public_textarea" name="<?php echo Html::getInputName($publicityForm, 'publicityContent') ?>" data-errormessage-value-missing="内容不能为空！"  data-prompt-position="inline" data-prompt-target="contentError"  data-validation-engine="validate[required,maxSize[1000]]" style="width:560px"></textarea>
...
<script>
        ...
        $.each(data.result, function (index, file) {
            ...
            $(".up_test_list").append(' <li><input type="hidden" name="PublicityForm[imageUrl][]" value="'+file.url+'"/><img src="'+file.url+'" alt=""><span class="delBtn"></span></li>');
         });
