...
/* @var $this yii\web\View */  $this->title="班级管理";
...
<dl class="sc_manage">
<dt>班级管理<i style="font-size:14px;">（入学年份）</i></dt>
...
<?php if (in_array("20201", $departmentArray)) { ?>
    <dd class="clearfix">
        ...
        <div class="takeC">
            <?php foreach ($primaryYearArray as $v) { ?>
                <div class="tack_box b_jq_number">
                    <span class="tackL take_has"><?php echo $v ?><i></i></span>

                    <div class="add_class  clearfix overJs hide">
                        <div class="u_tran_t"></div>
                        <div class="addL">
                            <?php $class = new pos_ClassInfoService();
                            $primaryClassList = $class->searchClassInfo($schoolId, "20201", $v);
                            foreach ($primaryClassList->classList as $value) {
                                ?>
                                <span class="add_name">
                                     <em><?php echo $value->classNumber ?></em>
                                        <i><?php echo $value->className ?></i>
                                            </span>
                            <?php } ?>

                        </div>
                        <div class="addR">
                                            	<span class="span_hide span_click hide">
                                                <select>
                                                ...
                                                <input type="text" value="" class="text text_Width text_tow">
                                                <button type="button" class="btn take_ok2">确定</button>
                                                <button type="button" class="btn btn_cancel">取消</button>
                                            </span>
                            <button type="button" class="takeR_btn takeR_btn_js take_addClass" style="float:right;">
                                +添加班级
                            </button>
                        </div>
                    </div>
        ...
        <div class="takeR">
                                <span class="span_hide hide">
                                    ...
                                    <button type="button" class="btn take_oks">确定</button>
                                    <button type="button" class="btn btn_cancel no_ok">取消</button>
                                </span>
            <button type="button" class="takeR_btn gradeJs ">+添加年级</button>
        </div>
        <hr>
    </dd>
<?php
...
if (in_array("20202", $departmentArray)) {
    ...
    <dd class="clearfix">
        ...
        <div class="takeC">
            <?php foreach ($juniorYearArray as $v) { ?>
                <div class="tack_box b_jq_number">
                    <span class="tackL take_has"><?php echo $v ?><i></i></span>
                    ...
                    <div class="add_class  clearfix overJs hide">
                        ...
                        <div class="addL">
                            <?php $class = new pos_ClassInfoService();
                            $juniorClassList = $class->searchClassInfo($schoolId, "20202", $v);
                            foreach ($juniorClassList->classList as $value) {
                                ?>
                                <span class="add_name">
                                     <em><?php echo $value->classNumber ?></em>
                                        <i><?php echo $value->className ?></i>
...
if (in_array("20203", $departmentArray)) {
    ...
    <dd class="clearfix">
        ...
        <div class="takeC">
            <?php foreach ($highYearArray as $v) { ?>
                <div class="tack_box b_jq_number">
                    <span class="tackL take_has"><?php echo $v ?><i></i></span>
                    ...
                    <div class="add_class  clearfix overJs hide">
                        ...
                        <div class="addL">
                            <?php $class = new pos_ClassInfoService();
                            $highClassList = $class->searchClassInfo($schoolId, "20203", $v);
                            foreach ($highClassList->classList as $value) {
                                ?>
                                <span class="add_name">
                                     <em><?php echo $value->classNumber ?></em>
                                        <i><?php echo $value->className ?></i>
