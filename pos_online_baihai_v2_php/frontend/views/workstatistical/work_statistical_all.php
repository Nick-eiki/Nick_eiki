...
?>
<div class="main col1200 clearfix tch_hmwk_result"   id="requireModule" rel="<?php echo publicResources_new2() . '/js/app/classes/tch_hmwk_result_all'?>">
        ...
        <?php else:?>
            <ul class="topic_userList">
                <?php foreach($overtimeId as $v):?>
                    <li class=""> <a href="javascript:;"><?php echo WebDataCache::getTrueName($v); ?></a></li>
                <?php endforeach;?>
                <?php foreach($noAnswerdId as $v1):?>
                    <li ><a class="ac" href="javascript:;"><?php echo WebDataCache::getTrueName($v1); ?></a></li>
                <?php endforeach;?>
            </ul>
        <?php endif;?>
