...
?>
<div class="main col1200 clearfix tch_hmwk_result"   id="requireModule" rel="<?php echo publicResources_new2() . '/js/app/classes/tch_hmwk_result'?>">
...
//                asort($leastRad);
//                $leastArr = array_slice($leastRad,0,2);
//                ksort($leastArr);
//                $num=[];
//                $rate=[];
//                foreach($leastArr as $k=>$v){
//                    $num[] = $k;
//                    $rate[] = $v;
//                }
//                if(count($leastArr) == 2){
//                    if($rate[0]>0 && $rate[1]>0){
//                        echo '客观题第'.$num[0].'正确率为'.$rate[0].'%，第'.$num[1].'的正确率为'.$rate[1].'%。';
//                    }else if($rate[0]==0 && $rate[1]==0){
//                        echo '客观题第'.$num[0].'和第'.$num[1].'全部学生答错，需加强学习！';
//                    }else if($rate[0]==0 && $rate[1]!=0){
//                        echo '客观题第'.$num[0].'全部学生答错，第'.$num[1].'的正确率为'.$rate[1].'%。';
//                    }else if($rate[0]!=0 && $rate[1]==0){
//                        echo '客观题第'.$num[1].'全部学生答错，第'.$num[0].'的正确率为'.$rate[0].'%。';
//                    }
//                }else if(count($leastArr) == 1){
//                    if($rate[0]>0) {
//                        echo '客观题第' . $num[0] . '正确率为' . $rate[0] . '%。';
//                    }else if($rate[0] == 0){
//                        echo '客观题第'.$num[0].'全部学生答错，需加强学习！';
//                    }
//                }
            ?>
...
//                    }
//                    if (count($leastArr) == 2) {
//                        if ($rate[0] <= 60 && $rate[1] <= 60) {
//                            echo '<div class="pd25 words">主观题第' . $num[0] . '正确率为' . $rate[0] . '%，第' . $num[1] . '的正确率为' . $rate[1] . '%，部分学生掌握较薄弱，需要加强关注  !</div>';
//                        } else if ($rate[0] <= 60 && $rate[1] > 60) {
//                            echo '<div class="pd25 words">主观题第' . $num[0] . '正确率为' . $rate[0] . '%，部分学生掌握较薄弱，需要加强关注  !</div>';
//                        } else if ($rate[0] > 60 && $rate[1] <= 60) {
//                            echo '<div class="pd25 words">主观题第' . $num[1] . '正确率为' . $rate[1] . '%，部分学生掌握较薄弱，需要加强关注  !</div>';
//                        }
//                    } else if (count($leastArr) == 1) {
//                        if ($rate[0] <= 60) {
//                            echo '<div class="pd25 words">主观题第' . $num[0] . '正确率为' . $rate[0] . '%，部分学生掌握较薄弱，需要加强关注  !</div>';
