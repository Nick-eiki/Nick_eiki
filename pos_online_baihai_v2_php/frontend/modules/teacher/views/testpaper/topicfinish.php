...
$this->registerCssFile($backend_asset . '/css/teacher.css'.RESOURCES_VER);
...
function daoshu(){
     ...
     if(timer.innerHTML == 1){
        window.location.href="<?php echo url('/teacher/searchquestions/knowledge-point-questions')?>";
...
<div class="grid_19 main_r">
    <div class="main_cont test">
        <div class="test_success" style="height:400px;">
            <div class="currentRight">
                <div class="success_div">
                    ...
                    <p class="tc">系统将在<i id="time">5</i>秒后自动跳转到题目列表，若未发生跳转，请点击<a href="<?php echo url('/teacher/testpaper/add-topic')?>">“录入题目”</a>或<a href="<?php echo url('/teacher/searchquestions/knowledge-point-questions')?>">“查看列表”</a>。</p>
