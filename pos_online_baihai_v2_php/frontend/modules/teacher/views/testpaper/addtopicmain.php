...
var preview ={
    ...
    answerOptionJson:<?php echo $answerOption?>,
            ...
            <div class="NBox">
                <div class="row">
                    ...
                    <div class="formR" style="width: 500px">
                        ...
                        ?>
                        <!--     <textarea id="analytical" data-validation-engine="validate[required]" data-errormessage-value-missing="解析不能为空"><?php /*echo $info->analytical*/?></textarea>
           -->
                    </div>
                </div>
            </div>
...
<!--<div class="popBox previewBox hide" title="题目预览">
	<div class="QuestionCont">
        <h5 class="Q_title">大题题题目内容题目内容题目内容目</h5>
        <div class="sub">
            <h6 class="subTitle">第1小题</h6>
            <p>小题题目内容题目内题目内容题目内容题目内容</p>
            <dl class="clearfix">
                <dt>备选项:</dt>
                <dd>A</dd>
                <dd>B</dd>
    ...
    <div class="btnBar">
    	<a class="openAnalyBtn">查看答案和解析</a><span>难度:<em>1</em>&nbsp;&nbsp;录入:<i>我自己</i></span>
    </div>
    <div class="A_cont clearfix">
    	<dl>
        	<dt>答案:</dt>
            <dd>
            	<h6>1小题:</h6>
        ...
        <dl class="analyCont">
        	<dt>解析:</dt>
            <dd>解析内容解析内容解析内容解析内容解析内容解析内容解析内容</dd>
        </dl>
    </div>
</div>
-->
