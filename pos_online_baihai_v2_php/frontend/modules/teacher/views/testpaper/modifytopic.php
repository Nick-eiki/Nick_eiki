...
/* @var $this yii\web\View */  $this->title='修改题目';
...
$this->registerCssFile(Yii::$app->request->baseUrl  .'/ueditor/themes/default/css/ueditor.min.css'.RESOURCES_VER);
$this->registerJsFile(Yii::$app->request->baseUrl  .'/ueditor/ueditor.config.little.js'.RESOURCES_VER);
$this->registerJsFile(Yii::$app->request->baseUrl  .'/ueditor/ueditor.all.min.js');
    ...
    $(function(){
        ...
        $('.p_reservation').live('click',function(){
            if ($('#form_id').validationEngine('validate')) {
                var url="<?php echo url('/teacher/testpaper/save-question-head') ?>";
                ...
                var kid=$("#treeval").val();
                var name=UE.getEditor('container').getContent();
                if(tags==""){
                ...
                $.post(url,{'questionID':questionID,'questionPrice':questionPrice,'provience':provience,'city':city,'county':county,'gradeID':gradeID,
                    ...
                    function(msg){
                        location.href="<?php echo url('/teacher/testpaper/modify-ques-content')?>"+"?question="+msg+"&operation=<?php echo $data->operation?>";
                    })
            }
        })
    })
...
<ul class="box_data_list">
    ...
    <li class="clearfix">
        ...
        <div class="box_select">
            ...
            ?>
        </div><span id="gradeError" class="errorTxt"></span>
    </li>
    <li class="clearfix">
        <label class="species"><i>*</i>科目:</label>
        <div class="box_select">
            <?php
            echo CHtmlExt::dropDownListAjax('item', $data->subjectid, ArrayHelper::map(SubjectModel::getSubByGrade($data->gradeid,1), 'secondCode', 'secondCodeValue'),
                array(
                    "data-prompt-position"=>"inline",
                    "data-prompt-target"=>"subjectError",
                    'ajax' => array(
                        'url' => Yii::$app->urlManager->createUrl('ajax/get-topic-type'),
                        'data' => array('grade'=>new \yii\web\JsExpression('jQuery("#gradeID").val()'),'subject' => new \yii\web\JsExpression('this.value')),
            ...
            ?>
        </div><span id="subjectError" class="errorTxt"></span>
    </li>
    <li class="clearfix">
    ...
    <li class="clearfix">
        ...
        <div class="box_select">
            ...
            ?>
        </div><span id="complexityError" class="errorTxt"></span>
    </li>
    <li class="clearfix">
    ...
    <div id="questionBox_0">
        <ul class="box_data_list">
            <li class="clearfix">
                ...
                <div id="tree_0" class="word_box treeParent"  style="height: auto; width: 700px">
...
<div class="row submit_BtnBar">
    <div class="formL"></div>
    <div class="formR">
        <button class="bg_blue nextBtn p_reservation">保存题目</button>
    </div>
</div>
