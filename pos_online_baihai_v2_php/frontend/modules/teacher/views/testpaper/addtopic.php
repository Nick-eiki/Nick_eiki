...
$this->registerCssFile(Yii::$app->request->baseUrl  .'/ueditor/themes/default/css/ueditor.min.css');
$this->registerJsFile(Yii::$app->request->baseUrl  .'/ueditor/ueditor.config.little.js');
            ...
            $('.p_reservation').live('click',function(){
                if ($('#form_id').validationEngine('validate')) {
                    ...
                    $.post(url,{'questionID':questionID,'questionPrice':questionPrice,'provience':provience,'city':city,'county':county,'gradeID':gradeID,
                        ...
                        function(msg){
                          location.href="<?php echo url('/teacher/testpaper/save-ques-content')?>"+"?question="+msg+"&operation=<?php echo $data->operation?>";
                        })
                }
            })
        })
...
<div class="grid_19 main_r">
    <div class="main_cont">
        ...
        <h4><?php if($data->operation == 1)echo "录入"; else echo"修改";   ?>题干</h4>
        </div>
