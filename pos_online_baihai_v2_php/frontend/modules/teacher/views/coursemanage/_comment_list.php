...
<?php foreach ($commentList as $replyVal) { ?>
	<ul class="course_list">
		<li>
			<span class="c_title_h">
				<img src="<?php echo publicResources() . WebDataCache::getFaceIcon($replyVal->commentUserID)?>" alt=""  onerror="userDefImg(this);" data-type="header" height="40" width="40">
			</span>

			<p class="p_name">
				<em class="name">
					<?php echo $replyVal->commentUserName; ?></em>
				针对
				<em class="name">
					<?php echo $replyVal->commenTitletName; ?>
				</em>
				发表（好评/评论）：
			</p>
			...
			<p class="btn_parent">
				...
				<span class="span_link">
					<a href="javascript:;" class="name reply_btn">回复</a>
						<?php if (user()->id == $replyVal->commentUserID) { ?>
					<a href="javascript:" class="name na_del comment_del" commentId="<?php echo $replyVal->commentID; ?>">删除</a>
						<?php } ?>
			...
			<li class="counter_style">
				...
				<div class="textareaBox hide pop">
					...
					<div class="btnArea">
						...
						<em class="txtCount">可以输入 <b class="num">140</b> 字</em>
						<button type="button" id="preply_add" class="sendBtn2"
...
<?php } ?>
	...
	<?php
	 echo \frontend\components\CLinkPagerExt::widget( array(
			'pages' => $pages,
			'updateId' => '#srchResult',
			'htmlOptions' => array('class' => 'minipage page'),
			'maxButtonCount' => 5
		)
	);
	?>
