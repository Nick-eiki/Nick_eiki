    ...
    <div class="notice main_cont test titlePush">
        ...
        <div class="form_list form_style">
            ...
            <div class="row">
                ...
                <div class="formR">
                    <input type="text" class="text txt" value="<?php echo Html::encode($model->questionTeamName); ?>"
                           name="<?php echo Html::getInputName($model, 'questionTeamName') ?>"
                           data-prompt-target="nameError"
                           data-prompt-position="inline"
                           data-validation-engine="validate[required,maxSize[30]]">
                    <?php echo frontend\components\CHtmlExt::validationEngineError($model, 'questionTeamName') ?><span
                        class="altTxt">(30字以内)</span>
                </div>
            </div>
            <span id="nameError" class="errorTxt" style="left:427px"></span>
            ...
            <div class="row">
                ...
                <div class="formR">
                    ...
                    <?php echo frontend\components\CHtmlExt::validationEngineError($model, 'gradeID') ?><span
                        id="gradeError" class="errorTxt" style="left:120px"></span>
                </div>
            </div>
            <div class="row">
                <div class="formL">
                ...
                <div class="formR">
                    ...
                    <?php echo frontend\components\CHtmlExt::validationEngineError($model, 'subjectID') ?><span
                        id="subjectError" class="errorTxt" style="left:120px"></span>
                </div>
            </div>
            <div class="row">
                <div class="formL">
                ...
                <div class="formR">
                    ...
                    echo frontend\widgets\extree\XTree::widget([
                        ...
                        'options' => [],
                        'htmlOptions' => ['data-validation-engine' => 'validate[required]',
            ...
            <div class="row">
                ...
                <div class="formR">
                    <input type="text" value="<?php echo $model->labelName; ?>" class="input_box text"
                           name="<?php echo Html::getInputName($model, 'labelName') ?>">
