    ...
    <div class="container homwork_info">
        <div class="pd25">
            ...
            <?php }
                ...
                <p><em>年级：</em><?php echo WebDataCache::getGradeName($homeworkData->gradeId)?></p>
            <?php }
            if (!empty($homeworkData->subjectId)) { ?>
                <p><em>科目：</em><?php echo SubjectModel::model()->getSubjectName($homeworkData->subjectId)?></p>
            <?php }
            ...
            <button type="button" data-id="<?php echo $homeworkData->id?>"  class="sc disableBtn isAssigned">收藏作业</button>
            <?php } else { ?>
            <button type="button" id="upbtnBox" data-id="<?php echo $homeworkData->id?>" data-exist="<?php echo $homeworkIsExist?>" class="sc">收藏作业</button>
            <?php } ?>
            ...
            <div class="formR">
                <div class="textareaBox">
                    ...
                    <div class="btnArea">
                        ...
                        <button type="button" style="right:-3px" data-id="<?php echo $homeworkData->id?>" class="sendBtn btn_Submit">发送</button>
                    </div>
                </div>
            </div>
        </div>
