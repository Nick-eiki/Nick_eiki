...
<div class="grid_19 main_r">
    <div class="main_cont test_class_overall_appraisal">
        <div class="title"><a
                href="<?php echo url('teacher/managetask/work-details', ['classhworkid'=>$relId]) ?>"
        ...
        <div class="correctPaper">
            ...
            <ul class="up_details_list">
                ...
                <?php if ($result->knowledgeId !== '' && $result->knowledgeId !== null) { ?>
                    <li class="clearfix">
                        <p>知识点：<span><?php echo KnowledgePointModel::findKnowledgeStr($result->knowledgeId); ?></span>
                        </p>
                    </li>
                <?php } ?>
            ...
            <div class="correctPaperSlide">
                <div class="testPaperWrap mc pr">
                    <ul class="testPaperSlideList slid">
                        <?php foreach ($homeworkResult->picList as $v) {
                            ?>
                            <li name="<?= $v->picID ?>"><img id="<?= $v->picID ?>"
                                                             src="<?php echo publicResources() . $v->picUrl ?>"
                                                             width="830"  alt=""/>
            ...
            <?php if ($homeworkResult->isCheck == 0 || $homeworkResult->isCheck == 2) { ?>
                <div class="test_class_this tc">

                    <a href="<?= url('teacher/managetask/new-correct-paper', ['homeworkanswerid' => $homeworkanswerid]) ?>"
                       class="w160 btn50 bg_green a_button c_Btn">去批改</a>
                </div>
            <?php } ?>
        </div>
    </div>
