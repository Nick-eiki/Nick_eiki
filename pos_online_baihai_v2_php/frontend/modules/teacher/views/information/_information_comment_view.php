...
foreach ($data as $replyVal) {  ?>
    <ul class="course_list">
        <li>
            <span class="c_title_h"><img src="<?php echo publicResources() . WebDataCache::getFaceIcon($replyVal->commentUserID);?>" alt="" height="40" width="40"></span>

            <p class="p_name"><em class="name"><?php echo $replyVal->commentUserName; ?></em>针对<em
                    class="name"><?php echo $replyVal->commenTitletName; ?></em>发表（好评/评论）：</p>
            ...
            <div class="textareaBox hide pop">
                <textarea  id="reply_content<?php echo $replyVal->commentID?>"
                    class="textarea checkTextarea"></textarea>
				<div class="btnArea">
    ...
    <?php foreach ($replyVal->subReplays as $commentVal) { ?>
            ...
            <li class="counter_style">
                <span class="c_title_h"><img src="<?php echo publicResources() . WebDataCache::getFaceIcon($commentVal->replayUserID);?>" alt="" height="40" width="40"></span>
                ...
                <div class=" textareaBox hide pop">
                    <textarea id="preply_content<?php echo $commentVal->replayID; ?>"
                        class="textarea checkTextarea"></textarea>
					<div class="btnArea">
