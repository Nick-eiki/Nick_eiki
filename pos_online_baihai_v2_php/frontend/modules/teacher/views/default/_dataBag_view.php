...
<form id="form_editId">
    <ul class="form_list">
        <li>
            <div class="formL">
                <label><i></i>资料袋名称:<input type="hidden" id="dataBagId" value="<?php echo $id;?>"></label>
            </div>
            <div class="formR">
                <input id="edit_name" type="text" class="text" value="<?php echo $model->Name;?>" data-validation-engine="validate[required]">
            </div>
        </li>
        <li>
            <div class="formL">
