...
<div class="grid_19 main_r">
            ...
            <div class="correctPaperSlide">
                <div class="testPaperWrap mc pr">
                    <ul class="testPaperSlideList slid">
                        ...
                        <li><img src="<?=publicResources().$v->imageUrl?>" width="830"  alt=""/>
    ...
    <?php $imageArr=array();
      foreach($testResult->testCheckInfoS as $v){
          array_push($imageArr,$v->imageUrl);
      }
