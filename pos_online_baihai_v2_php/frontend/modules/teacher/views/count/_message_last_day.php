...
<div class="tabox message">
	<table class="unfinished_list" cellpadding="0"
	       cellspacing="0">
		...
		<tr height="40" class="">
			...
			<th width="145">学号</th>
			<th width="145">姓名</th>
			<?php foreach ($lastResult->listHead as $subVal) { ?>
		...
		<tbody id="message">
		<?php foreach ($lastResult->list as $val) { ?>
			<tr height="40" class="">
				<td width="145">
					<?php echo $val->creatTime; ?>
				</td>
				<td width="143">
			<span>
                <label for="chk01"><?php echo $val->stuID; ?></label>
	        </span>
				</td>
				<td width="145"><?php echo $val->stuUserName; ?></td>
