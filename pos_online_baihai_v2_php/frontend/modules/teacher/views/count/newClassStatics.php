 ...
 */
;
$this->registerJsFile(publicResources_new() . '/js/echarts/echarts.js');
$this->registerJsFile(publicResources_new() . '/js/echarts/html5shiv.min.js');
$this->registerJsFile(publicResources_new() . '/js/echarts/respond.min.js');
    ...
    <div class="main_cont statistClass class_statist">
        ...
        <div class="statistics parsonal">
                    ...
                    <div class="tabCont">
                        ...
                        <div class="tabItem hide">
                            <ul class="resultList testClsList clearfix" >
                                ...
                                <li type="6">成绩曲线（总成绩/单科成绩）</li>
                                <li type="7">考试成绩分布图</li>
                                <li type="8">三率统计（低分率，高分率，及格率）</li>
                            </ul>
                            <?php
            ...
            <div class="statis_chart">
                ...
                <div class="curveSubjectSelect"></div>
