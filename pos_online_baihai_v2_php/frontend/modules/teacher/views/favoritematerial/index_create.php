...
<div class="main col1200 clearfix platform_question_bank" id="requireModule" rel="app/teacher/teacher_home_courseware">
    ...
    <div class="tch_resource container col910 omega currency_hg">
        <div class="sUI_pannel tab_pannel">
            ...
            <div class="pannel_r favbar">
                <a href="<?php echo Url::to(['/teacher/prepare/upload-files']) ?>">上传课件</a>
            </div>
        </div>
    </div>
    <div class="aside col260 alpha no_bg">
        <ul class="custom_toggle">
            ...
            <li class="establish"><a
                    href="<?php echo Url::to(['/teacher/favoritematerial/index-create', 'department' => $department, 'subjectId' => $subjectId]) ?>"
                    class="<?php echo $groupType == 2 ? 'ac' : '' ?>">我的上传</a></li>
        </ul>
        <div id="groupList">
            <?php echo $this->render('_group_list', ["department" => $department, "subjectId" => $subjectId, 'groupType' => $groupType,
                'collectGroupList' => $collectGroupList, 'groupId' => $groupId])?>
        </div>
    </div>
...
<div id="modify" class="popBox hide" title="修改组名">
    <div class="popCont">
        <div class="input"><input placeholder="请输入组的名称" type="text" maxlength="15" value="<?php
            if (!empty($groupId) && $groupInfo = SeFavoriteMaterialGroup::getGroupInfo($groupId, user()->id)) {
