                    ...
                    <?php echo CHtmlExt::activeDropDownListAjax($model, 'subject', ArrayHelper::map(SubjectModel::getSubByGrade($model->gradeId), 'secondCode', 'secondCodeValue'),
                        [
                            ...
                            'ajax' => array(
                                ...
                                'data' => ['subject' => new JsExpression('this.value'),"grade"=>new JsExpression('jQuery("#'.Html::getInputId($model, 'gradeId').'").val()')],
...
<script>
    ...
    function checkKnowledge() {
        /* if ($('#
        <?php //echo  Html::getInputId($model, 'knowledgePointId')?>').val() == "") {
         popBox.errorBox('知识点不能为空');
         return false;
         }*/
