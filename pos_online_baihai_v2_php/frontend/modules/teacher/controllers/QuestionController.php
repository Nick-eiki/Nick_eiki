...
class QuestionController extends TeacherBaseController
{
    ...
    public function actionIndex()
    {
        ...
        $questionArr = \yii\helpers\ArrayHelper::getColumn($questionIdList, 'questionId', false);
    ...
    public function actionDefineGroup()
    {
        ...
        $userId = user()->id;
        $SeQuestionGroupModel = new SeQuestionGroup();
        $defineGroups = $SeQuestionGroupModel->defineGroup($userId,$subjectId, $department);
    ...
    public function actionMoveGroupOther()
    {
        ...
        $userId = user()->id;
        $SeQuestionGroupModel = new SeQuestionGroup();
        $moveGroupIds = $SeQuestionGroupModel->defineGroup($userId,$subjectId, $department);
