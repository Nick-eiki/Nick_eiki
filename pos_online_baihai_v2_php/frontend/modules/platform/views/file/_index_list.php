    ...
    <div class="no_bg">
        <div class="sUI_pannel bg_blue_l classes_fList">
            <div class="pannel_l clsoption_list">
                <span class="sort_a"><i class="bq1"></i>排序</span>
                        <span>
                        <a class="read <?php if (app()->request->get('sortType') == 'readNum') {
                            echo 'cur';
                        } ?> sort_search"
                    ...
                    <span>
                        <a class="fav <?php if (app()->request->get('sortType') == 'favoriteNum') {
                            echo 'cur';
                        } ?> sort_search"
                    ...
                    <span>
                        <a class="download <?php if (app()->request->get('sortType') == 'downNum') {
                            echo 'cur';
                        } ?> sort_search"
        ...
        <ul class="sUI_dialog_list cls_rList clearfix">
            <?php foreach ($materialList as $material) { ?>
                ...
                if($material->isNewFile()){echo 'news';} ?>">
                    <div class="cls_lf_list">
                        ...
                        <div class="sUI_pannel sUI_pannel_min">
                            <h5><a class="addReadNum" target="_blank" title="<?= Html::encode($material->name) ?>"
                                   href="<?= Url::to(['/ajax/file-details', 'id' => $material->id, 'url' => $material->url]) ?>"><?= Html::encode($material->name) ?></a>
                            </h5>
                        </div>
