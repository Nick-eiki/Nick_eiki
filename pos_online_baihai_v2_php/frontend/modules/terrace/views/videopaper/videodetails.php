...
//新添加两个js
$this->registerJsFile(publicResources_new() . "/js/jwplayer/jwplayer.js".RESOURCES_VER,[ 'position'=>\yii\web\View::POS_HEAD] );
$this->registerJsFile(publicResources_new() . "/js/jwplayer/jwplayer.html5.js".RESOURCES_VER,[ 'position'=>\yii\web\View::POS_HEAD] );
$this->title="视频详情";
/**
 * Created by PhpStorm.
 * User: mahongru
