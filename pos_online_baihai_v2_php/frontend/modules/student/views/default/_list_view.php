...
if (empty($modelList)) {
    ...
    foreach ($modelList as $key => $item) {
        ...
        <dl class="QA_list">
            <dt class="newTime">
                <em><?php echo date('Y', \common\helper\DateTimeHelper::timestampDiv1000($item->createTime)); ?></em><?php echo date('m', \common\helper\DateTimeHelper::timestampDiv1000($item->createTime)); ?>
            </dt>
            <dd>
                ...
                <?php if ($item->ifSelfAsked($studentId)) { ?>
                    ...
                    <div class="QA_cont">
                        ...
                        <h5>提出了1个<?php echo \frontend\models\dicmodels\SubjectModel::model()->getSubjectName($item->subjectID); ?>问题</h5>
                        ...
                        <div class="form_list">
                            ...
                            <?php if (!empty($item->aqDetail)) { ?>
                                <div class="row">
                                    ...
                                    <div class="formR">
                                        <span class="gray_777"> <?php echo StringHelper::htmlPurifier($item->aqDetail); ?></span>
                                        <?php if ($item->imgUri !== null && $item->imgUri !== '') { ?>
                                            <div class="QA_cont_imgBox">
                                                ...
                                                foreach ($img as $k => $imgSrc) {
                                                    ?>
                                                    <a class="fancybox"  href="<?php echo $imgSrc; ?>" data-fancybox-group="gallery_<?php echo $item->aqID; ?>">
                                                        <img width="160" height="120" src="<?php echo $imgSrc; ?>" alt=""/>
                                                    </a>
                                                <?php } ?>
                                            </div>
                                        <?php } ?>
                            ...
                            <div class="row row_button">
                                ...
                                <div class="formR tr">
                                    <button type="button" class=" w120 bg_green answerBtn textBtnJS">马上回答</button>
                                </div>
                            </div>

                            <div class="textarea_box hide">
                                <div class="row">
                                    <div class="formL">
                                        <label>答:</label>
                                    </div>
                                    <div class="formR detail">
                                        <textarea></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="formR tr">
                                        <button type="button" class=" w120 bg_green answerBtn resultAnswer"
                                                data_val="<?php echo $item->aqID; ?>">提交答案
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                <?php } else { ?>
                    <?php if ($item->ifAccepted($studentId) == 0) { ?>
                        <div class="QA_cont">
                            <span class="arrow"></span>
                            <h5>回答了1道<?php  echo \frontend\models\dicmodels\SubjectModel::model()->getSubjectName($item->subjectID); ?>问题</h5>
                            ...
                            <div class="form_list">
                                    ...
                                    <div class="formR">
                                        ...
                                        <?php if ($item->imgUri !== null && $item->imgUri !== '') { ?>
                                            <div class="QA_cont_imgBox">
                                                ...
                                                foreach ($img as $k=>$imgSrc) {
                                                    ?>
                                                    <a class="fancybox " href="<?php echo $imgSrc; ?>"
                                ...
                                <div class="row row_button">
                                    ...
                                    <div class="formR tr">
                                        <button type="button" class=" w120 bg_green answerBtn textBtnJS">继续回答</button>
                                    </div>
                                </div>
                                <div class="textarea_box hide">
                                    <div class="row">
                    ...
                    <?php } else { ?>
                        <div class="QA_cont">
                            <span class="arrow"></span>
                            <h5>1个<?php echo \frontend\models\dicmodels\SubjectModel::model()->getSubjectName($item->subjectID) ?>答案被采纳</h5>
    ...
    if ($pages->getPageCount() > $pages->getPage() + 1) {
        ...
        <script>
            var getEvent = function (userid, page) {
                $.get('<?php echo  url( 'student/default/get-pages') ?>', {userid: userid, page: page}, function (data) {
