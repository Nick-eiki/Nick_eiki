...
<script>
	$(function(){
		...
		$('#search_word').click(function(){
			...
			$.get('<?php echo url("student/answer/answer-questions");?>',{keyWord:keyWord},function(data){
	...
	<div class="main_cont test answer_questions">
		<div class="title">
			...
			<div class="title_r clearfix">
                        <span>
                            <input type="text" class="text searchText" id="searchText">
							<button type="button" class="hideText TextBtn searchBtn " id="search_word">搜索</button>
                        </span>
