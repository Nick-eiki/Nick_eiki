...
<div class="currentRight grid_16 push_2 online_answer">
	...
	<div class="work_detais_cent">
		<h4>测验名称</h4>
		<ul class="ul_list">
			<li><span>1、</span>考察知识点：<?php ?></li>
			<li><span>2、</span>本试卷共包含<?php echo $testResult->countSize?>道题目，其中
				<?php $array=array();
		...
		<div class="btn_online">
			<button type="button" class="bg_green" id="btn_line_js">开始答题</button>
			<div class="time-item">
		...
		<div class="online_coom">
			<div class="tc">
				<button type="button" class="bg_red_d btn_js " id="finish" >完成答题</button>
			</div>
			<br>
		</div>
	</div>
...
//                    获取图片答案路径并且转成字符串
			...
			$.post("<?php echo url('student/managepaper/finishuplode')?>",{"answerList":JSON.stringify(titleObj),"examID":examID},function(result){
				if(result.code=="0"){
