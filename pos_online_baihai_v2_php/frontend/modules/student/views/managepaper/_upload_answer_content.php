...
<div class="impBox">
    <ul class="form_list">
        ...
        <li>
            ...
            <div class="formR">
                <span><?php echo $testResult->name?></span>
            </div>
        </li>
        <li>
            <div class="formL">
                <label><i></i>测验答案：</label>
            </div>
            <div class="formR">
                <div class=" clearfix" style="width:400px;">
                    <p class="addPic">
                        <a href="javascript:" class="a_button bg_blue id_btn">上传答案</a>
                ...
                <ul id="addImage" class="up_img up_img_js clearfix">
                    <?php if($answerResult->isUploadAnswer){ foreach($answerResult->testCheckInfoS as $v){?>
                    <li><img width="50" height="48" alt="" src="<?php echo $v->imageUrl?>">
                        <i></i>
                        <input class="url" type="hidden" value="<?php echo $v->imageUrl?>"></li>
                  <?php } }?>
                </ul>
                <div class="c_text"><em>试卷名称.jpg</em> <i>(25.7KB)</i><span class="Progress"><i class="Progress_i"></i></span></div>
