...
class ClassshortboardController extends ClassesBaseController
{
    ...
    public function actionIndex($classId)
    {
        ...
        return $this->render('index',['classId'=>$classId,'subjectNumber'=>$subjectNumber,'monthShortBoard'=>$monthShortBoard]);
    }
     ...
     * @return string
     */
    public function actionWeekShort($classId)
    {
     ...
     * @return string
     */
    public function actionDayShort($classId)
    {
        $this->getClassModel($classId);
     ...
     * @return array
     */
    public  function  getKnowledgePoint($classId,$subjectId,$BeginTime,$endTime,$limit=15){
     ...
     * @return string
     */
    public function actionWeaknessQuestions($classId,$kid,$timezone,$select){
        ...
        foreach($questionIdList as $v){
            ...
            array_push($testQuestionList,$dataArray);
        }
