        ...
        <div class="item sel_test_bar">
            <div class="sUI_tab">
                <ul class="tabList clearfix" style="background: #fff">
                    <li><a href="javascript:;" target="_blank" class="ac">班级作业统计</a></li>
                </ul>
            </div>
        </div>


        <div id="answerPage" style="background:white" class="pd25">
                        ...
                        <div class="form_r" style="margin-left:55px;">
                            <ul class="testList clearfix" id="select_year" data-url="<?= Yii::$app->getRequest()->getUrl()?>">
                                <?php foreach($years as $year){?>
                                    <li><a data-sel-item href="javascript:;" class="<?php if(date("Y",time()) == $year){echo 'sel_ac';} ?>" data-value="<?= $year?>"><?= $year ?></a></li>
                                <?php }?>
                    ...
                    <div class="row">
                        ...
                        <div class="form_r" style="margin-left:55px;">
                            <ul class="testList clearfix" id="select_month" data-url="<?= url::to('index',['classId'=>$classId]);?>">
                                ...
                                <li><a data-sel-item href="javascript:;" class="<?php if(date("m", strtotime("-1 month"))  == $month){echo 'sel_ac';} ?>" data-value="<?= $month ?>" ><?= $month ?>月</a></li>
                                <?php }?>
                            </ul>
                        </div>
                    </div>
