...
class ImagePathHelper
{
    ...
    public static function resUrl1($url)
    {
        ...
        if (stripos($url, '/upload') === 0) {
            ...
            $url = Url::to('http://banhai.com' . $url, false);
            return $url;
        } else {
            $url = Url::to('http://banhai.com/res' . $url, false);
            return $url;
        }
    }
    ...
    public static function getFilePic($url)
    {
        ...
        if (preg_match($regPdf, $r)) {
            return publicResources_new() . "/images/test_paper_img15.png";
        }
        if (preg_match($regxls, $r)) {
            return publicResources_new() . "/images/test_paper_img19.png";
        }
        if (preg_match($regtxt, $r)) {
            return publicResources_new() . "/images/test_paper_img7.png";
        }
