...
fixedHtml+='<a href="http://info.banhai.com/" class="game_subject_link"><span>首届全国中小学教师课件大赛</span></a>';//专题
...
$('.head_nav li').live({
	mouseover:function(){$(this).children('.subMenu').show()},
	mouseout:function(){$(this).children('.subMenu').hide()}
});
...
//select
sanhai_tools.setSelect=function(select_elm,text){
	var opts=$(select_elm).children('option');
	if(text){//如果有text,设定select的val
		opts.each(function(index, element) {
			if($(this).text()==text) $(select_elm).val($(this).val());
		});
	}
	else{//读取选中option的text,并返回
		var sel_text;
		opts.each(function(index, element) {
			if($(this).val()==select_elm.val()) sel_text=$(this).text();
		});
		return sel_text;
	}
};
...
*/				
		...
		var opts = $.extend(defaults, opts); 
			return this.each(function() {
				...
				if(opts.operate==true){
					$('.openSubMenu').unbind('click').click(function(){
	...
	mySelect: function(opts) {
	 ...
	 placeholder: function(opts) {
		...
		return this.each(function() {
			...
			var spanLeft=inputLeft+opts.left+5;
...
popBox.alertBox=popBox.confirmBox=function(html,trueFn,falseFn){
	var html=html||"你确定吗?";
	var popHtml='<div class="popBox confirmBox" title="确认" style="padding-top:10px">'+html+'</div>';
	$("body").append(popHtml);
	$('.confirmBox').dialog(
		{modal:true,width:500, close:function(){$(this).remove()},
			buttons: [
...
//添加表情弹窗
popBox.face_imgs=[
		{src:"../../images/face/88_thumb.gif",alt:"拜拜"},
		{src:"../../images/face/angrya_thumb.gif",alt:"发怒"},
		{src:"../../images/face/shamea_thumb.gif",alt:"害羞"},
		{src:"../../images/face/bs_thumb.gif",alt:"快哭了"},
		{src:"../../images/face/bs2_thumb.gif",alt:"鄙视"},
		{src:"../../images/face/bz_thumb.gif",alt:"闭嘴"},
		{src:"../../images/face/cj_thumb.gif",alt:"惊恐"},
		{src:"../../images/face/cool_thumb.gif",alt:"得意"},
		{src:"../../images/face/crazya_thumb.gif",alt:"抓狂"},
		{src:"../../images/face/cry.gif",alt:"衰"},
		{src:"../../images/face/cza_thumb.gif",alt:"馋"},
		{src:"../../images/face/dizzya_thumb.gif",alt:"晕"},
		{src:"../../images/face/gza_thumb.gif",alt:"鼓掌"},	
		{src:"../../images/face/h_thumb.gif",alt:"糗大了"},
		{src:"../../images/face/hatea_thumb.gif",alt:"尴尬"},	
		{src:"../../images/face/hearta_thumb.gif",alt:"爱心"},	
		{src:"../../images/face/heia_thumb.gif",alt:"偷笑"},	
		{src:"../../images/face/hsa_thumb.gif",alt:"色"},	
		{src:"../../images/face/kl_thumb.gif",alt:"可怜"},	
		{src:"../../images/face/kbsa_thumb.gif",alt:"抠鼻子"},	
		{src:"../../images/face/laugh.gif",alt:"憨笑"},	
		{src:"../../images/face/ldln_thumb.gif",alt:"惊讶"},	
		{src:"../../images/face/lovea_thumb.gif",alt:"飞吻"},	
		{src:"../../images/face/mb_thumb.gif",alt:"可爱"},	
		{src:"../../images/face/nm_thumb.gif",alt:"咒骂"},	
		{src:"../../images/face/ok_thumb.gif",alt:"ok"},	
		{src:"../../images/face/qq_thumb.gif",alt:"亲亲"},	
		{src:"../../images/face/sada_thumb.gif",alt:"大哭"},	
		{src:"../../images/face/sb_thumb.gif",alt:"撇嘴"},		
		{src:"../../images/face/sleepa_thumb.gif",alt:"睡觉"},	
		{src:"../../images/face/sleepya_thumb.gif",alt:"困"},	
		{src:"../../images/face/smilea_thumb.gif",alt:"微笑"},	
		{src:"../../images/face/yw_thumb.gif",alt:"疑问"},	
		{src:"../../images/face/yhh_thumb.gif",alt:"右哼哼"},	
		{src:"../../images/face/zhh_thumb.gif",alt:"左哼哼"},
		{src:"../../images/face/t_thumb.gif",alt:"呕吐"},
		{src:"../../images/face/yx_thumb.gif",alt:"阴险"},
		{src:"../../images/face/unheart.gif",alt:"心碎"},
		{src:"../../images/face/wq_thumb.gif",alt:"委屈"},
		{src:"../../images/face/x_thumb.gif",alt:"嘘"},
		{src:"../../images/face/zy_thumb.gif",alt:"调皮"}		
	];
...
popBox.private_new_msg=function(sendName_arr,fun,single){//[{'id':1,'name':'zhangsan'},{'id':3,'name':'李四'}]
	...
	if(single){
		...
		nameItem='<input id="sendName" type="text" class="text sel ui-autocomplete-input" autocomplete="off" style="width:150px"><input id="prv_sendName" type="hidden" class="sel">';
	}
...
//纠错弹窗
popBox.errorCorrect=function(fun,topic){//topic:题目纠错
	var title="";
	var inputItems="";
	if(topic){
		title="题目纠错";
		inputItems+='<input type="checkbox" class="chked hide" id="ch3" name="act_type">';
		inputItems+='<label class="chkLabel stuZ" for="ch3">错误类型</label>';
		inputItems+='<input type="checkbox" class="chked hide" id="ch4" name="act_type">';
		inputItems+='<label class="chkLabel patriarchZ" for="ch4">题目类型</label>';
		inputItems+='<input type="checkbox" class="chked hide" id="ch5" name="act_type">';
		inputItems+='<label class="chkLabel patriarchZ" for="ch5">题目答案</label>';
		inputItems+='<input type="checkbox" class="chked hide" id="ch6" name="act_type">';
		inputItems+='<label class="chkLabel patriarchZ" for="ch6">题目解析</label>';
		inputItems+='<input type="checkbox" class="chked hide" id="ch7" name="act_type">';
		inputItems+='<label class="chkLabel patriarchZ" for="ch7">题目知识点</label>';
		inputItems+='<input type="checkbox" class="chked hide" id="ch8" name="act_type">';
		...
		inputItems+='<input type="checkbox" class="chked hide" id="ch6" name="act_type">';
		inputItems+='<label class="chkLabel patriarchZ" for="ch6">其它</label>';
	}
	
	
	
	var html='<div id="errorCorrectBox" class="popBox errorCorrectBox hide" title="'+title+'">';
	...
	$('.textareaBox textarea').charCount({'num':300}).blur().placeholder({'value':"请输入错误描述！",top:10,left:10});
	$('.popBox .cancelBtn').click(function(){
...
popBox.errorCorrect_topic=function(id){//topic:题目纠错
		var inputItems='<input type="checkbox" class="chked hide" id="ch3" name="act_type" value="错误类型">';
		inputItems+='<label class="chkLabel stuZ" for="ch3">错误类型</label>';
		inputItems+='<input type="checkbox" class="chked hide" id="ch4" name="act_type" value="题目类型">';
		inputItems+='<label class="chkLabel patriarchZ" for="ch4">题目类型</label>';
