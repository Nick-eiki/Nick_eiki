...
var preview ={
	...
	subTypes:'<option showtypeid="1" value="1">单选题</option><option showtypeid="2" value=2">多选题</option><option showtypeid="3" value="3">填空题</option><option showtypeid="4" value="4">简答题</option>',//小题的类型
	...
	content:"",//Q:题目内容
	textContent:'',//题目内容文本
	answerContent:'11111111111',//A:答案
...
//----------------------------------------------------------------------------	
		...
		if(sel.length>0){
			for(var i=0, len=sel.length; i<len; i++){
				...
				html+='<div class="row">';
					...
					html+='</div>';
				html+='</div>';
				var ue=UE.getEditor('sel_'+this.selNum);//初始化富文本
	...
	onloadType:function(){
		...
		if(showType==1 || showType==2){
            ...
            html2+='<div class="ABox">';
				html2+='<div class="row">';
					html2+='<div class="formL"><label>答案:</label></div>';
		...
		if(type==1 || type==2){//选择题
			...
			html3+='<div class="I_QBox">';
				html3+='<div class="row">';
					...
					html3+='<div class="formR"><textarea id="sel_Q'+i+'"  class="ue_textarea"></textarea></div>';
				html3+='</div>';
			html3+='</div>';
			...
			html+='<div class="I_SBox">';
				html+='<div class="row">';
					html+='<div class="formL"><label>备选项<em>1</em></label></div>';
					html+='<div class="formR"><textarea id="sel_'+i+'" class="ue_textarea"></textarea></div>';
				html+='</div>';
			html+='</div>';
			...
			html+='<div class="I_QBox">';
				html+='<div class="row">';
				   html+=' <div class="formL">题目:</div>';
					html+='<div class="formR"><textarea id="content'+i+'" class="ue_textarea"></textarea></div>';
				html+='</div>';
			html+='</div>';
			html+='<div class="I_ABox">';
				html+='<div class="row">'; 
					html+='<div class="formL">答案:</div>';
					html+='<div class="formR"><textarea id="answerContent'+i+'" class="ue_textarea"></textarea></div>';
				html+='</div>';
			html+='</div>';
		   ...
		   html2+=' </div>';
			...
			html+='<div class="I_ABox">';
					html+='<div class="row">';
						html+='<div class="formL">答案:</div>';
						html+='<div class="formR"><textarea id="answerContent'+i+'" class="ue_textarea" name="single"></textarea></div>';
					html+='</div>';
				html+='</div>';
			pa.html(html);
			var uq=UE.getEditor('content'+i);
	...
	addSub:function(){
		...
		html+='<div class="subItem I_'+i+'">';
			...
			html+='<span title="sel_Q'+i+'"  class="delBtn delSubBtn">删除</span>';
			...
			$('.IBox .I_'+i).append(html);
			
			
			
			var uq=UE.getEditor('sel_Q'+this.subItem_id);
			/*uq.ready(function(){
				UE.getEditor('sel_Q'+this.id);
			});*/
			
			
			var us=UE.getEditor('sel_'+this.subItem_id);
			/*us.ready(function(){
				UE.getEditor('sel_'+this.id)
			})*/
	...
	//排序
	Sequence:function(pa,tag,attr,value){
...
$(function(){
	...
	//添加备选项
	$('.addSelBtn').die().live('click',function(){
