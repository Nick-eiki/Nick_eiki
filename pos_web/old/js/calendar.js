...
function calendar(id)
{
	...
	oBox.className='date';	
	var s='<ul class="title"><li><span style="color="#0066cc">2013年10月</span><a href="javascript:;" class="a1">上月</a><a href="javascript:;" class="a2">下月</a></li></ul><ul class="week"><li>一</li>';	
	s+='<li>二</li>';
	s+='<li>三</li>';
	s+='<li>四</li>';
	s+='<li>五</li>';
	s+='<li>六</li>';
	s+='<li>七</li></ul><ul class="dayList"></ul>';
	oBox.innerHTML=s;
